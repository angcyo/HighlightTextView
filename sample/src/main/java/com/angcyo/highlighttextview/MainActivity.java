package com.angcyo.highlighttextview;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                HighlightTextView highlightTextView = ((HighlightTextView) findViewById(R.id.content_text));
                highlightTextView.setText("!!请叫我女王大人!!");
